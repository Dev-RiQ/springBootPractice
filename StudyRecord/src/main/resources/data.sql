...
insert into studys values(  CURTIME() ,CURDATE() , 30, 2 , null ,'공부기록1');
insert into studys values(  CURTIME() ,CURDATE() , 150, 3 , null ,'공부기록2');
insert into studys values(  CURTIME() ,CURDATE() , 10, 2 , null ,'공부기록3');
insert into studys values(  CURTIME() ,CURDATE() , 5, 4 , null ,'공부기록4');
